...
def test_deve_permitir_propor_lance_quando_valor_eh_menor_que_o_valor_da_carteira(vini, leilao):
...
def test_nao_deve_permitir_propor_lance_com_valor_maior_ao_da_carteira(vini, leilao):
